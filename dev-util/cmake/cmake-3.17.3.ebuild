...
PATCHES=(
	...
	# purge Linux distribution related codes, make it compatible with Gentoo Prefix
	"${FILESDIR}"/00-cmake-purge-debian-version-module-platform.patch
	"${FILESDIR}"/01-cmake-purge-debian-version-module-GNUInstallDirs.patch
	"${FILESDIR}"/02-cmake-purge-debian-version-module-FindPkgConfig.patch
	"${FILESDIR}"/03-cmake-purge-debian-version-module-CMakeFindPackageMode.patch
